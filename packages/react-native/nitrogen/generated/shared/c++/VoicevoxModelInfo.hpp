...
namespace margelo::nitro::voicevox {
  ...
  /**
   * A struct which can be represented as a JavaScript object (VoicevoxModelInfo).
   */
  struct VoicevoxModelInfo final {
  public:
  ...
  public:
    VoicevoxModelInfo() = default;
    explicit VoicevoxModelInfo(std::string id, std::string filename, double sizeBytes, std::string downloadURL, std::string vvmId, std::vector<VoicevoxCharacter> characters, bool isDownloaded): id(id), filename(filename), sizeBytes(sizeBytes), downloadURL(downloadURL), vvmId(vvmId), characters(characters), isDownloaded(isDownloaded) {}

  public:
    friend bool operator==(const VoicevoxModelInfo& lhs, const VoicevoxModelInfo& rhs) = default;
  };
...
namespace margelo::nitro {
  ...
  // C++ VoicevoxModelInfo <> JS VoicevoxModelInfo (object)
  template <>
  struct JSIConverter<margelo::nitro::voicevox::VoicevoxModelInfo> final {
    static inline margelo::nitro::voicevox::VoicevoxModelInfo fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      jsi::Object obj = arg.asObject(runtime);
      return margelo::nitro::voicevox::VoicevoxModelInfo(
    ...
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::voicevox::VoicevoxModelInfo& arg) {
