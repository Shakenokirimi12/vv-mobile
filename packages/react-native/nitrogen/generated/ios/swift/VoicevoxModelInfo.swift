...
/**
 * Represents an instance of `VoicevoxModelInfo`, backed by a C++ struct.
 */
public typealias VoicevoxModelInfo = margelo.nitro.voicevox.VoicevoxModelInfo

public extension VoicevoxModelInfo {
  private typealias bridge = margelo.nitro.voicevox.bridge.swift

  /**
   * Create a new instance of `VoicevoxModelInfo`.
   */
